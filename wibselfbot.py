...
cl = WIB.LINE()
cl.login(token="EpeewgnhZdeFqD0xtCT3.sJyvHSvAXo8HIGQBEllXSW.mS4Ky2oRKSGCFZsA5sCpOrZylsUBaHM9fznpyYdvUJA=")
cl.loginResult()
...
╠͜͡➽ Hp  [key protect]
╠͜͡➽ Tr  [key trans]
╠͜͡➽ Profile  [key profil]
╠͜͡➽ Search  [key search]
╠͜͡➽ Steal  [key steal]
╠͜͡➽ Fun  [key fun ]
╠͜͡➽ Tts  [key tts]
╠͜͡➽ Sk  [set key]
╠͜͡➽ Dset  [grup setting]
╠͜͡➽ About  [tentang bot]
╚════════════╝
sᴜᴘᴘᴏʀᴛ ʙʏ : W⃟   I⃟   B⃟   
"""
...
╠͜͡➽ Hay /Ats  [tagall]
╠͜͡➽ Gift  [hadiah]
╠͜͡➽ Cancel  [cancel all]
╠͜͡➽ B  [cancel satu"]
╠͜͡➽ Out  [keluar grup]
╠͜͡➽ Out:  [nama grup]
╠͜͡➽ Outall  [keluar semua grup]
╠͜͡➽ Ciduk  [set sider]
╠͜͡➽ Intip  [cek sider]
╠͜͡➽ Lurk on / off  [set lurk]
╠͜͡➽ Lurkers  [cek lurk]
╠͜͡➽ Bqr  [buka qr]
╠͜͡➽ Tqr  [tutup qr]
╠͜͡➽ Invite  [contact]
╠͜͡➽ Invite:  [mid]
╠͜͡➽ Gurl  [ buka qr - link qr]
╠͜͡➽ Url  [link grup]
╠͜͡➽ Gn  [grup name]
╠͜͡➽ Ginfo  [grup info]
╠͜͡➽ Glist  [grup list]
╠͜͡➽ Glid  [grup mid]
╠͜͡➽ Info group:  [via git]
╚═════════════╝"""
...
╠͜͡➽ Ban:  [mid]
╠͜͡➽ Ban  [contact]
╠͜͡➽ Banall  [ban all member]
╠͜͡➽ Banlist  [cek banlist]
╠͜͡➽ Conban  [cek contact ban]
╠͜͡➽ .bn  [cek banlist mid]
╠͜͡➽ Clear ban  [clear banlist]
╠͜͡➽ Tampol:  [mid]
╠͜͡➽ Tampol   [kick banlist]
╚═════════════╝"""
...
╠͜͡➽  Uni  [unicode]
╠͜͡➽  Bc  [bc semua]
╠͜͡➽  Bcc  [bs semua contact]
╠͜͡➽  Bcg  [grup bc]
╠͜͡➽  Mlis  [daftar member]
╠͜͡➽  Flist  [daftar teman]
╠͜͡➽  Dsp  [cek speed]
╠͜͡➽  Tl:  [posting tl]
╠͜͡➽  Today  [hari ini]
╠͜͡➽  Inv: gc [invite grup creator]
╠͜͡➽  Gc  [gc creator]
╠͜͡➽  Add:  [add via mid]
╠͜͡➽  Reject  [reject undangan]
╠͜͡➽  Runtime  [cek run bot]
╠͜͡➽  Removechat  [hapus pesan]
╠͜͡➽  Restart  [merestart bot]
╠͜͡➽  Kedapkedip  [text]
╠͜͡➽  Imagetext  [text]
╚══════════════╝"""
...
╠͜͡➽  Micadd @  [tag]
╠͜͡➽  Micdel @  [tag]
╠͜͡➽  Mic target  [mimic target]
╠͜͡➽  Miclist  [mimic list]
╚═════════════╝"""
helpProtect = """「🛡️」- Hᴇʟᴘ ғᴏʀ Pʀᴏᴛᴇᴄᴛ -「🛡️」

╔═══════════╗
╠͜͡➽  Allprotect ᴏɴ/ᴏғғ    
╠͜͡➽  Protect ᴏɴ/ᴏғғ		   
╠͜͡➽  Qrprotect ᴏɴ/ᴏғғ		   
╠͜͡➽  Inviteprotect ᴏɴ/ᴏғғ			   
╠͜͡➽  Cancelprotect ᴏɴ/ᴏғғ
╚═══════════╝"""
helpSteal = """「👁️」- Hᴇʟᴘ ғᴏʀ Sᴛᴇᴀʟ -「👁️」

╔═════════════╗
╠͜͡➽  Steal gpic:  [foto grup]
╠͜͡➽  Steal gpic  [foto grup]
╠͜͡➽  Steal gn  [nama grup]
╠͜͡➽  Ssteal dp @  [tag]
╠͜͡➽  Steal cover @  [tag]
╠͜͡➽  Steal vid @  [tag]
╠͜͡➽  Steal name @  [tag]
╠͜͡➽  Steal bio @  [tag]
╠͜͡➽  Steal mid @  [mid]
╠͜͡➽  Steal contact @  [tag]
╠͜͡➽  Steal contact:  [mid]
╠͜͡➽  Steal info @  [tag]
╚═════════════╝"""
...
╠͜͡➽  Ig  [instagram]
╠͜͡➽  Wiki  [wikipedia]
╠͜͡➽  playstore  [playstore]
╠͜͡➽  Facebook  [facebook]
╠͜͡➽  Google  [google]
╠͜͡➽  Image [google image]
╠͜͡➽  .gt  [github]
╠͜͡➽  Jadwal sholat  [praytime]
╠͜͡➽  Lokasi  [location]
╠͜͡➽  Cuaca  [cuaca]
╚═════════════╝"""
helpSpam = """
...
╔══════════════╗
╠͜͡➽  Cium  [mid-jumlah]
╠͜͡➽  Spam grup  [mid-jumlah]
╠͜͡➽  Spam ᴏɴ/ᴏғғ  [jumlah-text]
╠͜͡➽  Spam gift  [spam gift]
╠͜͡➽  Wᴏʏ @  [spam 1000]
╠͜͡➽  Spamtag @  [tag]
╠͜͡➽  Spamtag pc @  [tag]
╠͜͡➽  Mycover  [cover]
